...
//    MarioGame game; // for tightly coupled - only runs mario game not other
    GamingConsole game; // for loosely coupled

//    public GameRunner(MarioGame game){ - for tightly coupled
//        this.game = game;
//    }
